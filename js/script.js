(function() {
    ...
    $.fn.hc_menu = function(options) {
        var settings = $.extend({
            ...
            this_ = $(this);
        var m_nav = $('<div class="m-nav"><button class="m-nav-close"><i class="fal fa-times"></i></button><button class="m-nav-close v2"><i class="fal fa-times"></i></button><div class="nav-ct"></div></div>');
        body.append(m_nav);
...
jQuery(function($) {
    ...
    var UI = {
        ...
        slider: function() {
            ...
            $('.cas-home .dots').after('<div class="slider-nums-v2 wow fadeInDown"><strong>' + add0(index) + '</strong><span> / ' + add0(len) + '</span></div>');
            $('.cas-home .ct .name').before('<div class="slider-nums wow fadeInDown"><strong>' + add0(index) + '</strong></div>');
            ...
            function slider_change(e) {
                ...
                $('.slider-nums-v2').find('strong').text(add0(e.page.index + 1));
            }
            ...
            if($.fn.slick){
                ...
                var years = $('.year-cas').slick({
                    slidesToShow: 5,
                    swipe: false,
                    nextArrow: '<span class="smooth his-arrow next"><i class="fal fa-chevron-right"></i></span>',
                    prevArrow: '<span class="smooth his-arrow prev"><i class="fal fa-chevron-left"></i></span>',
                    focusOnSelect: true,
    ...
    if ($('.filter-prd-mobile').length){
        $('.filter-prd-mobile').click(function(event) {
            $('.sb-product,.overlay,.close-sb').addClass('show');
            $('body').css('overflow', 'hidden');
        });
        $('.overlay,.close-sb').click(function(event) {
    ...
    if ($('.prd-branch').length){
        $('.purchase').click(function(event) {
            $("html, body").animate({ scrollTop: $('.prd-branch').offset().top - 80 }, 800);
        });
    }
    if (win.width() < 991) {
